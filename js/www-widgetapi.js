...
var lb=/#|$/;var mb=["https://web.archive.org/web/20260518233643/https://www.google.com"];function nb(){var a=this;this.g=[];this.h=function(){Promise.all(a.g.map(function(b){document.requestStorageAccessFor(b)})).then(function(){window.removeEventListener("click",a.h)})}}
...
n.sendMessage=function(a){a.id=this.id;a.channel="widget";a=JSON.stringify(a);var b=jb(this.g.src||"").replace("http:","https:");if(this.g.contentWindow)try{this.g.contentWindow.postMessage(a,b)}catch(c){c.name&&c.name==="SyntaxError"&&c.message&&c.message.indexOf("target origin ''")>0||console&&console.warn&&console.warn(c);}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};
...
/*
     FILE ARCHIVED ON 23:36:43 May 18, 2026 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 07:23:18 Jun 24, 2026.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 38.408
  LoadShardBlock: 153.402 (3)
  PetaboxLoader3.datanode: 171.737 (4)
  load_resource: 202.438
  PetaboxLoader3.resolve: 158.99
*/